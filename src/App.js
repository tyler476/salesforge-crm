      ...
      <div style={{ padding:24 }}>
        ...
        <div style={{ display:'flex', gap:8, marginBottom:20, flexWrap:'wrap' }}>
          ...
          <button className="btn-sm" onClick={()=>onImportMISMO&&onImportMISMO()} style={{ background:'rgba(26,154,92,.15)', border:'1px solid rgba(26,154,92,.3)', color:'#1a9a5c', display:'flex', alignItems:'center', gap:5 }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg> Import MISMO
          </button>
          <button className="btn-sm" onClick={()=>onExportMISMO&&onExportMISMO(contact)} style={{ background:'rgba(240,180,41,.12)', border:'1px solid rgba(240,180,41,.3)', color:'#c8960a', display:'flex', alignItems:'center', gap:5 }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg> Export MISMO
          </button>
        </div>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10, marginBottom:20 }}>
          {[['<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>','Email',contact.email],['<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.62 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91A16 16 0 0 0 14.09 15.91l1.27-.87a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>','Phone',contact.phone||'—'],['<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>','Address',contact.address||'—'],['<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>','Occupation',contact.occupation||'—']].map(([icon,label,val])=>(
            <div key={label} style={{ background:'var(--surface2)', borderRadius:8, padding:10 }}>
              <div style={{ fontSize:11, color:'var(--muted)', marginBottom:2, display:'flex', alignItems:'center', gap:4 }}><span dangerouslySetInnerHTML={{__html:icon}} /> {label}</div>
        ...
        <div style={{ marginBottom:16 }}>
          <div style={{ display:'flex', gap:8, marginBottom:8 }}>
            {['note','call','email'].map(t=>(
              <button key={t} onClick={()=>setNoteType(t)} style={{ padding:'5px 12px', borderRadius:6, fontSize:12, border:'1px solid', borderColor:noteType===t?'var(--accent)':'var(--border)', background:noteType===t?'rgba(59,130,246,.2)':'transparent', color:noteType===t?'var(--accent)':'var(--muted)', cursor:'pointer' }}>
                {t==='note'?<span style={{display:'flex',alignItems:'center',gap:4}}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg> Note</span>:t==='call'?<span style={{display:'flex',alignItems:'center',gap:4}}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.62 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91A16 16 0 0 0 14.09 15.91l1.27-.87a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg> Call</span>:<span style={{display:'flex',alignItems:'center',gap:4}}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg> Email</span>}
              </button>
            ))}
          </div>
          {noteType==='email' ? (
        ...
        <div>
          ...
          {activities.map((a,i)=>(
            <div key={i} style={{ display:'flex', gap:10, marginBottom:12 }}>
              <div style={{ display:'flex', marginTop:2 }}>{a.type==='call'?<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.62 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91A16 16 0 0 0 14.09 15.91l1.27-.87a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>:a.type==='email'?<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>:a.type==='stage'?<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>:<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>}</div>
              <div style={{ flex:1 }}>
                {a.type==='email' ? (
            ...
            <>
              ...
              <div style={{ marginBottom:20 }}>
                ...
                <div onClick={()=>{ setHelpOpen(false); onNavigate('hannah'); }}
                  ...
                  <div style={{ width:40, height:40, borderRadius:'50%', overflow:'hidden', border:'2px solid rgba(26,154,92,.4)', flexShrink:0 }}>
                    <img src="data:image/png;base64," alt="Hannah" style={{ width:'100%', height:'100%', objectFit:'cover' }} onError={e=>{ e.target.style.display='none'; e.target.parentElement.innerHTML='<div style="width:100%;height:100%;background:linear-gradient(135deg,#1a9a5c,#0d7a47);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:16px;">H</div>'; }} />
                  </div>
                  <div style={{ flex:1 }}>
                    <div style={{ fontWeight:700, fontSize:14, color:'var(--text)', marginBottom:2 }}>Chat with Hannah</div>
                    <div style={{ fontSize:12, color:'var(--muted)' }}>Get instant answers about loan programs, CRM features, and more</div>
                  </div>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1a9a5c" strokeWidth="2.5"><polyline points="9 18 15 12 9 6"/></svg>
                </div>
              </div>
                ...
                {workload.map(({member,total,overdue})=>(
                  <div key={member.id} style={{ marginBottom:14 }}>
                    <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:5 }}>
                      ...
                      {overdue>0 && <span style={{ background:'rgba(224,82,82,.15)', color:'#e05252', fontSize:10, fontWeight:700, padding:'1px 6px', borderRadius:8 }}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg> {overdue}</span>}
                    </div>
  ...
  return (
    <div className="overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal">
        ...
        <div style={{ display:'flex', gap:10, justifyContent:'flex-end' }}>
          <button className="btn-secondary" onClick={onClose}>Cancel</button>
          <button className="btn-primary" onClick={send} disabled={sending}>{sending ? 'Sending...' : <span style={{display:'flex',alignItems:'center',gap:4}}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg> Send Email</span>}</button>
        </div>
      </div>
    </div>
  );
            ...
            <div style={{ display:'flex', gap:16, marginBottom:32, flexWrap:'wrap' }}>
              {[
                ...
                <div key={card.label} style={{ background:'var(--surface)', border:'1px solid var(--border)', borderRadius:10, padding:'18px 22px', borderTop:`3px solid ${card.color}`, minWidth:150, flex:1 }}>
                  <div style={{ display:'flex', marginBottom:6 }} dangerouslySetInnerHTML={{__html:card.icon}} />
      ...
      <td style={{ padding:'4px 10px' }} onClick={e=>e.stopPropagation()}>
        <div style={{ display:'flex', alignItems:'center', gap:6 }}>
          ...
          {(() => { const ds = dueDateStatus(item.date); if(!ds||ds.label==='On track') return null;
            return <span title={ds.label} style={{ fontSize:10, fontWeight:700, padding:'1px 6px', borderRadius:3, background:ds.bg, color:ds.color, whiteSpace:'nowrap', flexShrink:0, display:'flex', alignItems:'center', gap:3 }}>{ds.label==='Overdue'?<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>:null} {ds.days}d {ds.label==='Overdue'?'late':'left'}</span>;
          })()}
        </div>
      </td>
        ...
        <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
          ...
          {ds && ds.label!=='On track' && (
            <span style={{ background:ds.bg, color:ds.color, border:`1px solid ${ds.color}44`, padding:'4px 10px', borderRadius:5, fontSize:12, fontWeight:700 }}>
              <span style={{display:'flex',alignItems:'center',gap:3}}>{ds.label==='Overdue'?<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>:null}{ds.days}d {ds.label==='Overdue'?'overdue':'left'}</span>
            </span>
          )}
        </div>
      </div>
      ...
      <div style={{ display:'flex', borderBottom:'1px solid var(--border)', background:'var(--surface2)', flexShrink:0 }}>
        {[{id:'details',icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>',label:'Details'},{id:'updates',icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',label:'Updates'},{id:'files',icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>',label:'Files'}].map(t=>(
          <button key={t.id} onClick={()=>setTab(t.id)} style={{ flex:1, padding:'10px', background:'none', border:'none', borderBottom:tab===t.id?'2px solid var(--accent)':'2px solid transparent', color:tab===t.id?'var(--accent)':'var(--muted)', fontWeight:tab===t.id?700:400, cursor:'pointer', fontSize:13, fontFamily:'inherit', display:'flex', alignItems:'center', justifyContent:'center', gap:6 }}>
            <span dangerouslySetInnerHTML={{__html:t.icon}} style={{display:"flex",alignItems:"center"}} />{t.label}
...
function UpdatesPanel({ item, profile, onClose, toast }) {
  ...
  const getFileIcon = (name) => {
    ...
    if(['jpg','jpeg','png','gif','webp'].includes(ext)) return '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>';
        ...
        <div style={{ display:'flex', gap:6 }}>
          {['updates','files','activity'].map(t=>(
            <button key={t} onClick={()=>setTab(t)} style={{ padding:'5px 14px', borderRadius:20, fontSize:12, border:'1px solid', borderColor:tab===t?'var(--accent)':'var(--border)', background:tab===t?'rgba(77,142,240,.2)':'transparent', color:tab===t?'var(--accent)':'var(--muted)', cursor:'pointer', fontWeight:600 }}>
              {t==='updates'?<span style={{display:'flex',alignItems:'center',gap:5}}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg> Updates</span>:t==='files'?<span style={{display:'flex',alignItems:'center',gap:5}}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg> Files</span>:<span style={{display:'flex',alignItems:'center',gap:5}}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg> Activity</span>}
            </button>
          ))}
        </div>
      </div>
        ...
        {tab==='files' && (
          <div>
            ...
            <button className="btn-primary btn-sm" onClick={()=>fileInputRef.current?.click()} disabled={uploadingFile} style={{ marginBottom:16, width:'100%', padding:12 }}>
              {uploadingFile ? 'Uploading...' : <span style={{display:'flex',alignItems:'center',gap:4}}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg> Upload File</span>}
            </button>
    ...
    <div style={{ padding:32 }}>
      ...
      <div style={{ display:'flex', gap:0, borderBottom:'1px solid var(--border)', marginBottom:24 }}>
        {['archive','trash'].map(t=>(
          <button key={t} onClick={()=>setTab(t)} style={{ padding:'8px 20px', background:'none', border:'none', borderBottom: tab===t?'2px solid var(--accent)':'2px solid transparent', color:tab===t?'var(--accent)':'var(--muted)', fontWeight:tab===t?700:400, cursor:'pointer', fontSize:14, fontFamily:'inherit', marginBottom:-1 }}>
            {t==='archive'?<span style={{display:'flex',alignItems:'center',gap:5}}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg> Archive</span>:<span style={{display:'flex',alignItems:'center',gap:5}}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg> Trash</span>}
          </button>
        ))}
      ...
      {!loading && items.length===0 && (
        <div style={{ textAlign:'center', padding:'60px 0', color:'var(--muted)' }}>
          <div style={{ marginBottom:12, display:'flex', justifyContent:'center' }}>{tab==='archive'?<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>:<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg>}</div>
...
function CalendarView({ profile, workspaces, toast }) {
  ...
  const saveEvent = async () => {
    ...
    if(editEvent) {
      ...
      toast(pushed ? 'Synced to Google Calendar' : 'Event updated');
    } else {
      await supabase.from('calendar_events').insert([payload]);
      const pushed = await pushToGoogleCalendar(payload);
      toast(pushed ? 'Created + synced to Google Calendar!' : 'Event created <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>');
    }
              ...
              <React.Fragment key={ev.id}>
                ...
                <div onClick={e=>openEdit(e,ev)}
                  ...
                  <div style={{ textAlign:'right', flexShrink:0 }}>
                    ...
                    <div style={{ fontSize:11, color:'var(--muted)', marginTop:2 }}>{ev.is_shared ? <span style={{display:'flex',alignItems:'center',gap:4}}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> Shared</span> : <span style={{display:'flex',alignItems:'center',gap:4}}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg> Private</span>}</div>
                  </div>
...
(function injectPresentationStyles() {
  if (document.getElementById('cf-pres-styles')) return;
  ...
  s.textContent = `
    ...
    @keyframes slideInB { from { transform:translateY(100%) } to { transform:translateY(0) } }
    @keyframes barH     { from { width:0 } to { width:var(--w) } }
    .cf-bar-v { transform-origin:bottom center; animation:barGrow .7s cubic-bezier(.34,1.56,.64,1) forwards; opacity:0 }
    .cf-bar-h { animation:barH .8s cubic-bezier(.25,.46,.45,.94) forwards }
    .cf-fade-up { animation:fadeUp .5s ease forwards; opacity:0 }
    .cf-fade-in { animation:fadeIn .4s ease forwards; opacity:0 }
    .cf-tooltip { position:absolute; background:#0c1a35; color:#fff; font-size:11px; padding:6px 10px; border-radius:6px; white-space:nowrap; pointer-events:none; z-index:999; font-family:Inter,sans-serif; box-shadow:0 4px 16px rgba(0,0,0,.4); opacity:0; transition:opacity .15s }
    .cf-tooltip.show { opacity:1 }
    .cf-tooltip::after { content:''; position:absolute; bottom:-4px; left:50%; transform:translateX(-50%); border:4px solid transparent; border-top-color:#0c1a35; border-bottom:0 }
    .cf-hover-bar:hover .cf-tooltip { opacity:1 }
  `;
  document.head.appendChild(s);
})();

// ── Pure calculation function (shared by builder + viewer) ────────────────────
function calcLoan({ loanAmount, rate, term }) {
  const P  = Number(loanAmount) || 0;
  const r  = Number(rate) || 0;
  const yr = Number(term) || 30;
  const mr = r / 100 / 12;
  const n  = yr * 12;
  const mp = mr > 0
    ? Math.round(P * mr * Math.pow(1+mr,n) / (Math.pow(1+mr,n) - 1))
    : P > 0 ? Math.round(P / n) : 0;
  const totalPaid = mp * n;
  const totalInt  = totalPaid - P;
  const equity5   = P > 0 ? Math.round(
    P - (P * Math.pow(1+mr,60) - mp * (Math.pow(1+mr,60)-1) / mr)
  ) : 0;
  const breakeven = P > 0 ? Math.round(30 + (P/100000)*6) : 0;
  const fmt = v => v >= 1000000 ? '$'+(v/1000000).toFixed(2)+'M' : v >= 1000 ? '$'+v.toLocaleString() : '$'+v;
  return { P, r, yr, mp, totalPaid, totalInt, equity5, breakeven, fmt };
}

function buildSlides({ borrowerName, loanType, loanAmount, rate, term, loName, loPhone, loEmail }) {
  const { P, r, yr, mp, totalPaid, totalInt, equity5, breakeven, fmt } = calcLoan({ loanAmount, rate, term });
  const product = 'Citizens Financial ' + loanType;
  const lo = { loName, loPhone, loEmail };
  return [
    {
      type:'cf-cover',
      borrowerName,
      ...
      highlights:[
        ...
        { badge:'Lowest Cost Loan',       loanAmount:fmt(P), product, value: totalInt>0 ? 'Save '+fmt(Math.round(totalInt*.1))+' total' : '—' },
        { badge:'Quickest Break Even',    loanAmount:fmt(P), product, value: breakeven>0 ? 'Break even in '+breakeven+' mos.' : '—' },
      ],
      ...lo,
    },
    {
    ...
    },
    {
      type:'cf-savings',
      metrics:[
        { badge:'Most Interest Savings', label:'Total over loan life',   value:totalInt>0?fmt(totalInt):'—',              description:'Total interest paid over a '+yr+'-year term at '+r+'% fixed rate' },
        { badge:'Monthly Savings',       label:'vs avg renter',          value:mp>0?fmt(Math.round(mp*.06)):'—',          description:'Estimated monthly savings vs continuing to rent in the local market' },
        { badge:'Equity by Year 5',      label:'Through amortization',   value:equity5>0?fmt(equity5):'—',                description:'Approximate equity through principal paydown in the first 5 years' },
      ],
    ...
    },
    {
      type:'cf-table',
      rows:[
        { label:'Loan Amount',     current:'Existing Loan',  newVal: fmt(P) },
        { label:'Loan Type',       current:'Current',        newVal: loanType },
        { label:'Term',            current:'Existing',       newVal: yr+' Years' },
        { label:'Interest Rate',   current:'Current Rate',   newVal: r+'%' },
...
const CF = {
  navy:'#0c1a35', green:'#1a9a5c', lightGreen:'rgba(26,154,92,.08)',
  text:'#111827', muted:'#6b7280', light:'#f0f4f8', border:'#e2e8f0', white:'#ffffff',
};
...
function SlideRenderer({ slide, index, total, companyName='Citizens Financial' }) {
  ...
  React.useEffect(() => { const t = setTimeout(()=>setMounted(true), 60); return ()=>clearTimeout(t); }, [slide]);

  const anim = (delay=0, duration='.6s') => mounted ? {
    animation: `fadeUp ${duration} ease ${delay}ms forwards`, opacity:0
  } : { opacity:0 };

  const barAnim = (delay=0) => mounted ? {
    animation: `barGrow .7s cubic-bezier(.34,1.56,.64,1) ${delay}ms forwards`,
    transformOrigin:'bottom center', opacity:0,
  } : { opacity:0 };

  const barHAnim = (pct, delay=0) => mounted ? {
    animation:`barH .8s ease ${delay}ms forwards`,
    '--w': pct+'%', opacity:1,
  } : { width:0 };

  const showTip = (e, text) => {
    const r = e.currentTarget.getBoundingClientRect();
    const pr = e.currentTarget.closest('[data-slide-root]')?.getBoundingClientRect() || {left:0,top:0};
    setTooltip({ show:true, x:r.left-pr.left+r.width/2, y:r.top-pr.top-10, text });
  };
  const hideTip = () => setTooltip(t=>({...t, show:false}));

  const Pill = ({ label, green=false }) => (
    <span style={{ display:'inline-block', background:green?CF.green:CF.navy, color:'#fff', fontSize:11, fontWeight:800, padding:'4px 12px', borderRadius:30, textTransform:'uppercase', letterSpacing:'.1em' }}>{label}</span>
  );
  const Logo = ({ h=28, invert=true }) => (
    <img src={LOGO_URL} alt={companyName} height={h} style={{ objectFit:'contain', filter:invert?'brightness(0) invert(1)':'none', display:'block' }} onError={e=>e.target.style.display='none'} />
  );
  const Dots = () => (
    <div style={{ position:'absolute', bottom:20, left:'50%', transform:'translateX(-50%)', display:'flex', gap:6 }}>
      {Array.from({length:total}).map((_,i)=>(
        <div key={i} style={{ width:i===index?20:6, height:6, borderRadius:3, background:i===index?CF.green:'rgba(0,0,0,.12)', transition:'all .3s' }} />
      ))}
    </div>
  );
  ...
  if (slide.type === 'cf-cover') return (
    <div data-slide-root style={{ width:1280, height:720, background:CF.white, fontFamily:"Inter,sans-serif", display:'flex', flexDirection:'column', position:'relative', overflow:'hidden' }}>
      {tooltip.show && <div className="cf-tooltip show" style={{ left:tooltip.x, top:tooltip.y, transform:'translateX(-50%)' }}>{tooltip.text}</div>}
      <div style={{ background:CF.navy, height:66, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 52px', flexShrink:0 }}>
        <Logo h={30} />
        <div style={{ color:'rgba(255,255,255,.5)', fontSize:13 }}>{slide.date}</div>
      </div>
      <div style={{ background:`linear-gradient(135deg,${CF.navy} 0%,#1a3464 100%)`, padding:'28px 52px 32px', flexShrink:0, ...anim(0) }}>
        ...
        <div style={{ fontFamily:"Cormorant Garamond,Georgia,serif", fontSize:36, fontWeight:700, color:'#fff', lineHeight:1.2 }}>
          ...
          <span style={{ color:'rgba(255,255,255,.75)' }}> decision:</span>
        </div>
      </div>
      <div style={{ flex:1, display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:20, padding:'24px 52px 52px', background:CF.light }}>
        {(slide.highlights||[]).map((c,i)=>(
          <div key={i} style={{ background:CF.white, border:`1px solid ${CF.border}`, borderRadius:14, padding:'24px 26px', display:'flex', flexDirection:'column', gap:10, boxShadow:'0 2px 12px rgba(0,0,0,.06)', position:'relative', overflow:'hidden', cursor:'default', ...anim(120+i*80) }}>
      ...
      <div style={{ height:46, background:CF.navy, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 52px', flexShrink:0 }}>
        <div style={{ color:'rgba(255,255,255,.75)', fontSize:12, fontWeight:600 }}>{slide.loName}</div>
        <div style={{ color:'rgba(255,255,255,.4)', fontSize:11 }}>{[slide.loPhone,slide.loEmail].filter(Boolean).join(' · ')}</div>
      </div>
      <Dots />
    </div>
  );
  ...
  if (slide.type === 'cf-payment') {
    const curr   = slide.currentTotal || 0;
    const newPay = slide.newTotal || 0;
    const maxH   = 200;
    const currH  = curr > 0 && newPay > 0 ? Math.round(curr/newPay*maxH) : maxH;
    const bars = [
      { label:'CURRENT LOAN', sub:'Existing Loan', total:curr, h:currH, highlight:false,
        tip:`Current total monthly payment: $${curr.toLocaleString()}` },
      { label:'OPTION 1', sub:'Citizens Financial '+slide.loanProduct, total:newPay, h:maxH, highlight:true,
        tip:`New monthly payment: $${(newPay||0).toLocaleString()} — saves $${Math.round((curr-newPay)||0).toLocaleString()}/mo` },
    ];
    return (
      <div data-slide-root style={{ width:1280, height:720, background:CF.white, fontFamily:"Inter,sans-serif", display:'flex', flexDirection:'column', overflow:'hidden', position:'relative' }}>
        {tooltip.show && <div className="cf-tooltip show" style={{ left:tooltip.x, top:tooltip.y, transform:'translateX(-50%)' }}>{tooltip.text}</div>}
        ...
        <div style={{ flex:1, display:'flex' }}>
          <div style={{ width:300, background:`linear-gradient(180deg,${CF.navy},#1a3464)`, padding:'36px 30px', display:'flex', flexDirection:'column', justifyContent:'center', flexShrink:0, ...anim(0) }}>
            ...
            <div style={{ marginTop:28, paddingTop:20, borderTop:'1px solid rgba(255,255,255,.1)' }}>
              ...
              <div style={{ fontSize:14, fontWeight:700, color:'rgba(255,255,255,.8)' }}>{slide.loanProduct}</div>
            </div>
          </div>
            ...
            <div style={{ flex:1, display:'flex', alignItems:'flex-end', gap:60, paddingBottom:20 }}>
              {bars.map((col,ci)=>(
                <div key={ci} style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:10 }}
                  onMouseEnter={e=>showTip(e, col.tip)} onMouseLeave={hideTip}>
                  <div style={{ fontSize:11, color:CF.muted, fontWeight:600, ...anim(200+ci*80) }}>Total</div>
                  <div style={{ fontSize:20, fontWeight:800, color:col.highlight?CF.green:CF.text, ...anim(220+ci*80) }}>${(col.total||0).toLocaleString()}</div>
                  <div style={{ width:110, height:col.h, borderRadius:'8px 8px 0 0', overflow:'hidden', position:'relative', background:'#e5e7eb', cursor:'default', ...barAnim(280+ci*120) }}>
                  ...
                  <div style={{ fontSize:11, color:CF.muted, textTransform:'uppercase', letterSpacing:'.06em', fontWeight:700, textAlign:'center', ...anim(300+ci*80) }}>{col.label}</div>
                  <div style={{ fontSize:12, color:CF.text, fontWeight:600, textAlign:'center', ...anim(320+ci*80) }}>{col.sub}</div>
                </div>
              ))}
            </div>
          </div>
  ...
  if (slide.type === 'cf-savings') {
    const rows = [
      { label:'Current Loan', val:slide.currentInterest, pct:100,                            color:'#94a3b8', tip:'Total interest on your existing loan over full term' },
      { label:'Citizens Financial', val:slide.newInterest, pct:parseFloat(slide.savingsPct||'85'), color:CF.green, tip:'Total interest at the new rate — significant savings!' },
    ];
    return (
      <div data-slide-root style={{ width:1280, height:720, background:CF.light, fontFamily:"Inter,sans-serif", display:'flex', flexDirection:'column', overflow:'hidden', position:'relative' }}>
        {tooltip.show && <div className="cf-tooltip show" style={{ left:tooltip.x, top:tooltip.y, transform:'translateX(-50%)' }}>{tooltip.text}</div>}
        <div style={{ background:CF.navy, height:64, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 52px', flexShrink:0 }}>
          <Logo h={26} />
        ...
        <div style={{ flex:1, display:'flex', flexDirection:'column', padding:'28px 52px 52px', gap:18 }}>
          ...
          <div style={{ background:CF.white, border:`1px solid ${CF.border}`, borderRadius:10, padding:'16px 22px', ...anim(320) }}>
            <div style={{ fontSize:10, fontWeight:800, color:CF.muted, textTransform:'uppercase', letterSpacing:'.1em', marginBottom:12 }}>Total Interest Comparison</div>
            {rows.map((row,ri)=>(
              <div key={ri} style={{ display:'flex', alignItems:'center', gap:14, marginBottom:ri===0?10:0 }}
                onMouseEnter={e=>showTip(e,row.tip)} onMouseLeave={hideTip}>
                <div style={{ width:160, fontSize:12, color:CF.muted, fontWeight:600, flexShrink:0 }}>{row.label}</div>
                <div style={{ flex:1, height:14, background:'#f1f5f9', borderRadius:7, overflow:'hidden', cursor:'default' }}>
                  <div style={{ height:'100%', borderRadius:7, background:row.color, ...barHAnim(row.pct, 350+ri*100) }} />
                </div>
      ...
      <div style={{ flex:1, display:'flex' }}>
        <div style={{ width:300, background:`linear-gradient(180deg,${CF.navy},#1a3464)`, padding:'36px 30px', display:'flex', flexDirection:'column', justifyContent:'center', flexShrink:0, ...anim(0) }}>
          ...
          <div style={{ marginTop:28, paddingTop:20, borderTop:'1px solid rgba(255,255,255,.12)' }}>
            ...
            {[{l:'Current Loan',v:slide.currentNetCost,hi:false},{l:'Citizens Financial',v:slide.newNetCost,hi:true}].map((r,i)=>(
              <div key={i} style={{ display:'flex', justifyContent:'space-between', marginBottom:8, fontSize:12 }}>
                ...
                <span style={{ color:r.hi?'#6ee7b7':'rgba(255,255,255,.75)', fontWeight:r.hi?800:600 }}>{r.v}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            {[1,2,3,4,5,6,7].map((yr,i)=>(
              <div key={yr} style={{ display:'flex', alignItems:'center', gap:14, fontSize:12 }}>
                ...
                <div style={{ flex:1, display:'flex', flexDirection:'column', gap:4 }}>
                  <div style={{ height:12, background:'#374151', borderRadius:4, opacity:.7, ...barHAnim(yr/7*100, 200+i*60) }} />
                  <div style={{ height:12, background:CF.green, borderRadius:4, ...barHAnim(Math.max(0,yr/7-.1)*92, 240+i*60) }} />
                </div>
              </div>
            ))}
      ...
      <div style={{ flex:1, padding:'24px 52px 48px', display:'flex', flexDirection:'column', overflow:'hidden' }}>
        ...
        <div style={{ flex:1, border:`1px solid ${CF.border}`, borderRadius:12, overflow:'hidden', ...anim(80) }}>
          <div style={{ display:'grid', gridTemplateColumns:'2fr 1fr 1fr', background:CF.navy }}>
            <div style={{ padding:'12px 20px', fontSize:12, color:'rgba(255,255,255,.35)', fontWeight:700, textTransform:'uppercase', letterSpacing:'.06em' }}></div>
            <div style={{ padding:'12px 20px', fontSize:12, color:'rgba(255,255,255,.85)', fontWeight:700, borderLeft:'1px solid rgba(255,255,255,.08)' }}>Current Loan</div>
            <div style={{ padding:'10px 20px', borderLeft:'1px solid rgba(255,255,255,.08)', display:'flex', alignItems:'center' }}>
              <Logo h={20} />
            </div>
          </div>
          {(slide.rows||[]).map((row,ri)=>(
            <div key={ri} style={{ display:'grid', gridTemplateColumns:'2fr 1fr 1fr', borderTop:`1px solid ${CF.border}`, background:row.highlight?CF.lightGreen:ri%2===0?CF.white:CF.light, transition:'background .2s' }}>
  ...
  if (slide.type === 'cf-closing') return (
    <div data-slide-root style={{ width:1280, height:720, background:CF.navy, fontFamily:"Inter,sans-serif", display:'flex', flexDirection:'column', overflow:'hidden', position:'relative' }}>
      ...
      <div style={{ position:'absolute', bottom:0, left:0, right:0, height:4, background:`linear-gradient(90deg,${CF.green},transparent 60%)` }} />
      <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'48px 80px', position:'relative' }}>
        ...
        <div style={{ background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.12)', borderRadius:16, padding:'20px 40px', textAlign:'center', ...anim(240) }}>
  ...
  return (
    <div style={{ width:1280, height:720, background:CF.navy, display:'flex', alignItems:'center', justifyContent:'center', color:'rgba(255,255,255,.4)', fontSize:18, fontFamily:'Inter,sans-serif' }}>
...
function PublicPresentationViewer({ token }) {
  ...
  const [liveTerm,   setLiveTerm]   = useState('30');
  ...
  useEffect(()=>{
    ...
    supabase.from('presentations').select('*').eq('view_token', token).single()
      .then(({ data, error }) => {
        ...
        // Initialize live params from first slide data if available
  ...
  useEffect(()=>{
    const h = e => {
      if(e.key==='ArrowRight'||e.key==='ArrowDown') setSlideIdx(s=>Math.min(s+1,(pres?.slides?.length||1)-1));
      if(e.key==='ArrowLeft'||e.key==='ArrowUp')   setSlideIdx(s=>Math.max(s-1,0));
    };
    window.addEventListener('keydown', h);
    return ()=>window.removeEventListener('keydown', h);
  }, [pres]);

  // Live recalculate when sliders change
  useEffect(()=>{
    if (!pres || !showPanel || !liveRate || !liveAmount) return;
    const t = setTimeout(()=>{
      const s0 = pres.slides?.[0] || {};
      const newSlides = buildSlides({
        borrowerName: s0.borrowerName || pres.contact_name || '',
        loanType: 'Purchase',
        loanAmount: liveAmount,
        rate: liveRate,
        term: liveTerm,
        loName:  s0.loName  || pres.lo_name || '',
        loPhone: s0.loPhone || '',
        loEmail: s0.loEmail || '',
      });
  ...
  }, [liveRate, liveAmount, liveTerm, showPanel, pres]);

  if (loading) return (
    <div style={{ background:'#060f1d', minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', color:'rgba(255,255,255,.4)', fontFamily:'Inter,sans-serif', flexDirection:'column', gap:16 }}>
      <div style={{ width:44, height:44, borderRadius:'50%', border:'3px solid rgba(255,255,255,.08)', borderTopColor:'#1a9a5c', animation:'spin 1s linear infinite' }} />
      Loading presentation…
    </div>
  );
  if (error) return (
    <div style={{ background:'#060f1d', minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', color:'rgba(255,255,255,.4)', fontFamily:'Inter,sans-serif' }}>{error}</div>
  );

  if (pres.template_type==='pdf' && pres.pdf_url) return (
    <div style={{ background:'#060f1d', minHeight:'100vh', display:'flex', flexDirection:'column' }}>
      <div style={{ background:'#0c1a35', padding:'14px 28px', display:'flex', alignItems:'center', justifyContent:'space-between', borderBottom:'1px solid rgba(255,255,255,.08)', flexShrink:0 }}>
        <img src={LOGO_URL} alt="Citizens Financial" style={{ height:26, filter:'brightness(0) invert(1)' }} onError={e=>e.target.style.display='none'} />
        <a href={pres.pdf_url} target="_blank" rel="noreferrer" style={{ background:'rgba(255,255,255,.08)', color:'#fff', padding:'7px 16px', borderRadius:6, textDecoration:'none', fontSize:13, border:'1px solid rgba(255,255,255,.12)' }}>Download PDF</a>
      </div>
  ...
  const displaySlides = liveSlides || pres.slides || [];
  const curr = displaySlides[slideIdx] || {};
  const { mp: liveMP, totalInt: liveTotalInt } = calcLoan({ loanAmount:liveAmount, rate:liveRate, term:liveTerm });
  const liveFmt = v => v >= 1000000 ? '$'+(v/1000000).toFixed(2)+'M' : v >= 1000 ? '$'+v.toLocaleString() : '$'+v;

  return (
    <div style={{ background:'#060f1d', minHeight:'100vh', display:'flex', flexDirection:'column', fontFamily:'Inter,sans-serif' }}>
      {/* Header */}
      <div style={{ background:'#0c1a35', height:52, display:'flex', alignItems:'center', padding:'0 28px', borderBottom:'1px solid rgba(255,255,255,.07)', flexShrink:0 }}>
        <img src={LOGO_URL} alt="Citizens Financial" style={{ height:24, filter:'brightness(0) invert(1)', opacity:.8 }} onError={e=>e.target.style.display='none'} />
        <div style={{ flex:1, textAlign:'center', fontSize:12, color:'rgba(255,255,255,.4)' }}>{pres.contact_name}</div>
        <button onClick={()=>setShowPanel(p=>!p)} style={{ background: showPanel?'#1a9a5c':'rgba(255,255,255,.08)', border:'1px solid', borderColor:showPanel?'#1a9a5c':'rgba(255,255,255,.12)', color:'#fff', padding:'6px 16px', borderRadius:6, cursor:'pointer', fontSize:12, fontWeight:600, display:'flex', alignItems:'center', gap:6 }}>
          ...
          {showPanel ? 'Close Scenarios' : 'Explore Scenarios'}
        </button>
      </div>

      {/* Main slide */}
      <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'24px 32px', minHeight:0 }}>
        <div style={{ width:'100%', maxWidth:1100, aspectRatio:'16/9', borderRadius:14, overflow:'hidden', boxShadow:'0 32px 80px rgba(0,0,0,.6)' }}>
          <ScaledSlide slide={curr} index={slideIdx} total={displaySlides.length} companyName={pres.company_name||'Citizens Financial'} />
        </div>
        <div style={{ display:'flex', alignItems:'center', gap:20, marginTop:22 }}>
          <button onClick={()=>setSlideIdx(s=>Math.max(s-1,0))} disabled={slideIdx===0}
            style={{ background:'rgba(255,255,255,.08)', border:'1px solid rgba(255,255,255,.1)', color:'#fff', borderRadius:8, padding:'9px 22px', cursor:slideIdx===0?'not-allowed':'pointer', opacity:slideIdx===0?.35:1, fontSize:13, fontWeight:600 }}>← Prev</button>
          <div style={{ display:'flex', gap:6 }}>
            {displaySlides.map((_,i)=>(
              <div key={i} onClick={()=>setSlideIdx(i)} style={{ width:i===slideIdx?22:7, height:7, borderRadius:4, background:i===slideIdx?'#1a9a5c':'rgba(255,255,255,.2)', cursor:'pointer', transition:'all .25s' }} />
            ))}
          </div>
          <button onClick={()=>setSlideIdx(s=>Math.min(s+1,displaySlides.length-1))} disabled={slideIdx===displaySlides.length-1}
            style={{ background:'rgba(255,255,255,.08)', border:'1px solid rgba(255,255,255,.1)', color:'#fff', borderRadius:8, padding:'9px 22px', cursor:slideIdx===displaySlides.length-1?'not-allowed':'pointer', opacity:slideIdx===displaySlides.length-1?.35:1, fontSize:13, fontWeight:600 }}>Next →</button>
        </div>
        <div style={{ fontSize:11, color:'rgba(255,255,255,.2)', marginTop:10 }}>Use ← → arrow keys to navigate</div>
      </div>

      {/* What-If Panel */}
      {showPanel && (
        <div style={{ background:'#0c1a35', borderTop:'1px solid rgba(255,255,255,.1)', padding:'20px 40px', animation:'slideInB .3s ease' }}>
          <div style={{ maxWidth:900, margin:'0 auto' }}>
            <div style={{ fontSize:11, fontWeight:800, color:'rgba(255,255,255,.4)', textTransform:'uppercase', letterSpacing:'.1em', marginBottom:16 }}>Explore Different Scenarios</div>
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr 1.2fr', gap:24, alignItems:'end' }}>
              {/* Rate slider */}
              <div>
                <div style={{ display:'flex', justifyContent:'space-between', marginBottom:8 }}>
                  <span style={{ fontSize:12, color:'rgba(255,255,255,.6)', fontWeight:600 }}>Interest Rate</span>
                  <span style={{ fontSize:14, color:'#6ee7b7', fontWeight:800 }}>{liveRate}%</span>
                </div>
                <input type="range" min="2" max="12" step="0.125" value={liveRate} onChange={e=>setLiveRate(e.target.value)}
                  style={{ width:'100%', accentColor:'#1a9a5c', cursor:'pointer' }} />
              ...
              <div>
                <div style={{ display:'flex', justifyContent:'space-between', marginBottom:8 }}>
                  <span style={{ fontSize:12, color:'rgba(255,255,255,.6)', fontWeight:600 }}>Loan Amount</span>
                  <span style={{ fontSize:14, color:'#6ee7b7', fontWeight:800 }}>${(Number(liveAmount)||0).toLocaleString()}</span>
                </div>
              ...
              {/* Term */}
              <div>
                <div style={{ fontSize:12, color:'rgba(255,255,255,.6)', fontWeight:600, marginBottom:8 }}>Loan Term</div>
                <div style={{ display:'flex', gap:6 }}>
                  {['10','15','20','25','30'].map(t=>(
                    <button key={t} onClick={()=>setLiveTerm(t)} style={{ flex:1, padding:'7px 0', borderRadius:6, border:`1px solid ${liveTerm===t?'#1a9a5c':'rgba(255,255,255,.12)'}`, background:liveTerm===t?'rgba(26,154,92,.2)':'transparent', color:liveTerm===t?'#6ee7b7':'rgba(255,255,255,.5)', fontSize:11, fontWeight:700, cursor:'pointer' }}>{t}yr</button>
                  ))}
                </div>
              </div>
              {/* Live results */}
              <div style={{ background:'rgba(26,154,92,.1)', border:'1px solid rgba(26,154,92,.25)', borderRadius:10, padding:'12px 16px' }}>
                <div style={{ fontSize:10, color:'rgba(255,255,255,.4)', textTransform:'uppercase', letterSpacing:'.08em', marginBottom:10 }}>Updated Estimates</div>
...
function PresentationBuilderModal({ contact, profile, onClose, toast, onSent, pricingRate, importedLoanData }) {
  ...
  useEffect(()=>{
    supabase.from('presentation_templates').select('*')
      .eq('company_id', profile.company_name).order('created_at',{ascending:false})
      .then(({data})=>setTemplates(data||[]));
  },[]);

  // Regenerate slides when live params change (debounced)
  useEffect(()=>{
    if (!showAdjust || !liveRate || !liveAmount || step!=='preview') return;
    const t = setTimeout(()=>{
      const newSlides = buildSlides({
    ...
    return ()=>clearTimeout(t);
  }, [liveRate, liveAmount, liveTerm, showAdjust]);

  // ── Generate ──────────────────────────────────────────────────────────────
  const generatePresentation = () => {
    setGenerating(true); setSlides([]); setSlideIndex(0); setSelectedTemplate(null); setStep('preview');
    setLiveRate(form.rate); setLiveAmount(form.loan_amount); setLiveTerm(form.term);
    setTimeout(()=>{
      setSlides(buildSlides({
        borrowerName: form.borrower_name, loanType: form.loan_type,
        loanAmount: form.loan_amount, rate: form.rate, term: form.term,
  ...
  const useTemplate = tmpl => {
    setSelectedTemplate(tmpl); setSlideIndex(0);
  ...
  const send = async () => {
    ...
    try {
      ...
      const { error } = await supabase.from('presentations').insert([{
        ...
        pdf_url:isPdf?selectedTemplate.pdf_url:null, view_token:token, created_by:profile.id, lo_name:form.lo_name,
      }]);
      ...
      const emailHtml = `<div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;background:#f0f4f8;border-radius:14px;overflow:hidden;">
        <div style="background:#0c1a35;padding:36px 44px;">
          <img src="${LOGO_URL}" alt="Citizens Financial" style="height:36px;filter:brightness(0) invert(1);margin-bottom:12px;display:block;"/>
          <p style="color:rgba(255,255,255,.45);margin:0;font-size:13px;letter-spacing:.08em;text-transform:uppercase;">Personalized Mortgage Presentation</p>
        </div>
  ...
  // ── PREVIEW — full screen with live sliders ───────────────────────────────
  if (step==='preview') {
    const isPdf   = selectedTemplate?.template_type === 'pdf';
              ...
              {templates.length===0
                ...
                : templates.map(t=>(
                    <div key={t.id} onClick={()=>setSelectedTemplate(t)}
                      ...
                      <div style={{ display:'flex', justifyContent:'center' }}>{t.template_type==='pdf'?<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>}</div>
                      <div style={{ flex:1 }}>
        ...
        <div style={{ padding:'16px 28px', borderTop:'1px solid var(--border)', display:'flex', justifyContent:'flex-end', gap:10, flexShrink:0 }}>
          ...
          {parsed && (
            <button onClick={()=>{ onImport(parsed.contact, parsed.loan); onClose(); toast('Loan data imported!'); }}
              ...
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg> Import to CRM
            </button>
          )}
        </div>
      </div>
  ...
  return (
    <div style={{ position:'fixed', top:0, right:0, width:480, height:'100vh', background:'var(--surface)', borderLeft:'1px solid var(--border)', zIndex:500, display:'flex', flexDirection:'column', boxShadow:'-8px 0 48px rgba(0,0,0,.4)' }}>
      ...
      <div style={{ display:'flex', borderBottom:'1px solid var(--border)', flexShrink:0 }}>
        {[['grid','<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg> Rate Grid'],['inputs','<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg> Parameters'],['manual','<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg> Manual'],['notes','<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg> Notes']].map(([id,lbl])=>(
...
// ─── MAIN APP ─────────────────────────────────────────────────────────────────
// ─── HANNAH FULL PAGE ─────────────────────────────────────────────────────────
function HannahPage({ profile }) {
  const HANNAH_PHOTO = 'data:image/png;base64,';
  const [messages, setMessages] = useState([
    { role:'assistant', content:"Hi! I'm Hannah, your Citizens Financial assistant. I'm here to help with CRM assistance, loan programs, client scenarios, and anything else you need. What can I help you with today?" }
  ]);
...
Respond with well-structured answers using bullet points and headers. Be concise but thorough. For the dedicated Hannah page, give more detailed answers. Never mention SalesForge.`
  ...
  const renderContent = (text) => text.split('\n').map((line,i)=>{
    ...
    if (line.startsWith('### ')) return <div key={i} style={{ fontWeight:700, fontSize:14, color:'var(--text)', marginTop:12, marginBottom:4 }}>{line.replace('### ','')}</div>;
    if (line.startsWith('## '))  return <div key={i} style={{ fontWeight:700, fontSize:15, color:'var(--text)', marginTop:14, marginBottom:6 }}>{line.replace('## ','')}</div>;
    if (line.startsWith('# '))   return <div key={i} style={{ fontWeight:700, fontSize:17, color:'var(--text)', marginTop:16, marginBottom:8 }}>{line.replace('# ','')}</div>;
    if (!line.trim()) return <div key={i} style={{ height:6 }} />;
    const parts = line.split(/\*\*([^*]+)\*\*/);
    return <div key={i} style={{ marginBottom:3 }}>{parts.map((p,pi)=>pi%2===1?<strong key={pi}>{p}</strong>:p)}</div>;
  });

  const suggestions = [
    'Walk me through setting up a new client presentation',
    'What are the FHA loan requirements?',
    'How does the mass send feature work?',
    'What VA loan benefits should I highlight to clients?',
    'How do I use the live scenario sliders?',
  ...
  return (
    <div style={{ height:'100%', display:'flex', flexDirection:'column', background:'var(--bg)' }}>
      {/* Header */}
      <div style={{ background:'#0c1a35', padding:'20px 32px', display:'flex', alignItems:'center', gap:20, flexShrink:0, borderBottom:'1px solid rgba(255,255,255,.08)' }}>
        <div style={{ width:52, height:52, borderRadius:'50%', overflow:'hidden', border:'2px solid rgba(26,154,92,.4)', flexShrink:0 }}>
        ...
        <button onClick={()=>setMessages([{ role:'assistant', content:"Hi! I'm Hannah. How can I help you today?" }])}
          style={{ marginLeft:'auto', background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.12)', color:'rgba(255,255,255,.5)', padding:'6px 14px', borderRadius:8, cursor:'pointer', fontSize:12, fontWeight:600 }}>
          Clear chat
        </button>
      </div>

      {/* Messages */}
      <div style={{ flex:1, overflowY:'auto', padding:'24px 32px', display:'flex', flexDirection:'column', gap:16, maxWidth:860, width:'100%', margin:'0 auto', alignSelf:'center', boxSizing:'border-box' }}>
        {messages.map((m,i)=>(
          <div key={i} style={{ display:'flex', gap:12, flexDirection:m.role==='user'?'row-reverse':'row', alignItems:'flex-end' }}>
            {m.role==='assistant' && (
              <div style={{ width:34, height:34, borderRadius:'50%', overflow:'hidden', border:'1px solid rgba(26,154,92,.3)', flexShrink:0 }}>
                <img src={HANNAH_PHOTO} alt="Hannah" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
              </div>
            )}
            <div style={{
              ...
              background: m.role==='user'?'#1a9a5c':'var(--surface)',
        ...
        {loading && (
          <div style={{ display:'flex', gap:12, alignItems:'flex-end' }}>
            ...
            <div style={{ padding:'14px 18px', borderRadius:'18px 18px 18px 4px', background:'var(--surface)', border:'1px solid var(--border)', display:'flex', gap:5, alignItems:'center' }}>
              {[0,1,2].map(i=><div key={i} style={{ width:7, height:7, borderRadius:'50%', background:'#1a9a5c', animation:`pulse 1.2s ease ${i*.2}s infinite` }} />)}
            </div>
          </div>
        )}
        {messages.length===1 && (
          <div>
            <div style={{ fontSize:12, color:'var(--muted)', fontWeight:700, textTransform:'uppercase', letterSpacing:'.07em', marginBottom:12 }}>Suggested questions</div>
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:8 }}>
              {suggestions.map((s,i)=>(
                <button key={i} onClick={()=>{ setInput(s); setTimeout(()=>inputRef.current?.focus(),50); }}
                  style={{ textAlign:'left', background:'var(--surface)', border:'1px solid var(--border)', borderRadius:12, padding:'12px 14px', fontSize:13, color:'var(--text)', cursor:'pointer', lineHeight:1.5, transition:'all .15s' }}
      ...
      <div style={{ padding:'16px 32px 24px', borderTop:'1px solid var(--border)', background:'var(--surface)', flexShrink:0 }}>
        <div style={{ maxWidth:860, margin:'0 auto', display:'flex', gap:10 }}>
          <textarea
            ...
            placeholder="Ask me anything about the CRM, loan programs, or client scenarios… (Enter to send)"
            rows={2}
            style={{ flex:1, padding:'12px 16px', borderRadius:12, border:'1px solid var(--border)', background:'var(--surface2)', color:'var(--text)', fontSize:14, outline:'none', fontFamily:'Inter,sans-serif', resize:'none', lineHeight:1.5 }}
          />
          <button onClick={send} disabled={!input.trim()||loading}
            style={{ width:48, borderRadius:12, background:input.trim()&&!loading?'#1a9a5c':'var(--border)', border:'none', cursor:input.trim()&&!loading?'pointer':'default', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0, transition:'background .15s' }}>
    ...
    <>
      ...
      <TopBar profile={profile} onSearch={setGlobalSearch} searchOpen={searchOpen} setSearchOpen={setSearchOpen} onNavigate={v=>setView(v,null)} onLogout={logout} workspaces={workspaces} onOpenWorkspace={w=>setView('workspace',w)}
        onGetResults={(q)=>{
          ...
          contacts.filter(c=>(c.full_name||'').toLowerCase().includes(ql)||(c.email||'').toLowerCase().includes(ql)).slice(0,5).forEach(c=>r.push({icon:'contacts',title:c.full_name,subtitle:c.email||c.company||'',type:'Contact',action:()=>setSelectedContact(c)}));
          workspaces.filter(w=>(w.name||'').toLowerCase().includes(ql)).forEach(w=>r.push({icon:'ws',title:w.name,subtitle:'Workspace',type:'Workspace',action:()=>setView('workspace',w)}));
          if('contacts'.includes(ql)) r.push({icon:'contacts',title:'Contacts',subtitle:'View all contacts',type:'Page',action:()=>setView('contacts',null)});
          if('pipeline'.includes(ql)||'funnel'.includes(ql)) r.push({icon:'contacts',title:'Lead Funnel',subtitle:'View pipeline',type:'Page',action:()=>setView('pipeline',null)});
