          ...
          {!helpPage ? (
            <>
              ...
              <div style={{ marginBottom:20 }}>
                ...
                <div onClick={()=>{ setHelpOpen(false); setView('hannah'); }}
...
function HannahPage({ profile }) {
  ...
  const [messages, setMessages] = useState([
    { role:'assistant', content:"Hi! I'm Hannah, your Citizens Financial assistant. I'm here to help with loan programs, CRM features, client scenarios, and anything else you need. What can I help you with today?" }
  ]);
...
You have more space here — give detailed, well-structured answers with examples when helpful. Use bullet points and headers. Never mention SalesForge.`;
  ...
  return (
    <div style={{ height:'100%', display:'flex', flexDirection:'column', background:'var(--bg)' }}>
      {/* Header */}
      <div style={{ background:'#0c1a35', padding:'20px 32px', display:'flex', alignItems:'center', gap:16, flexShrink:0, borderBottom:'1px solid rgba(255,255,255,.08)' }}>
      ...
      <div style={{ padding:'16px 32px 24px', borderTop:'1px solid var(--border)', background:'var(--surface)', flexShrink:0 }}>
        <div style={{ maxWidth:860, margin:'0 auto', display:'flex', gap:10 }}>
          <textarea
            ...
            placeholder="Ask Hannah anything about Citizens Financial programs or the CRM… (Enter to send, Shift+Enter for new line)"
            rows={2}
